...
const leadership = [
  {
    ...
    img: "https://customer-assets-m6fa6gv7.emergentagent.net/job_684ff79f-60f2-4b46-8ca8-a48ed8c1b296/artifacts/04yrapox_PHOTO-2026-08-07-10-12-28.jpg",
              ...
              <div className="lg:col-span-4">
                <div className="relative aspect-[4/5] overflow-hidden clip-corner bg-ink max-w-[380px]">
                  <img
                    ...
                    style={{ filter: "grayscale(1) contrast(1.2) brightness(1.02)" }}
                    draggable={false}
                  />
